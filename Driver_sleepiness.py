...
# starting camera using openCV
cap = cv2.VideoCapture(0)

# loading eye and mouth detecting model
path = 'C:/Users/sayal/Desktop/driver-drowsiness-project/shape_predictor_68_face_landmarks.dat'
...
while True:
    ...
    for face_roi in faces:
        ...
        if count>10:
            ...
            sound.play() # alarm will play if sleepy
